...
var Engine = (function(global) {
     ...
     * the need to add an additional function call here (left commented out). 
     * Collision detection on the entities is checked within the app.js file.
     */
    function update(dt) {
        updateEntities(dt);
        // checkCollisions();
    ...
    function render() {
        ...
        endImage = 'images/gameover.png';
        ctx.drawImage(Resources.get(endImage), 0, 40);
    }

    function renderWin() {
        // Renders the game winning image
        winImage = 'images/winning.png';
        ctx.drawImage(Resources.get(winImage), 0, 40);
    }
     ...
     */
    function reset() {
        // no additional features at the moment
    }
